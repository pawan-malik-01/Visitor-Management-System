                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card bg-placeholder" Style="color:#fff">
                                    <div class="card-header bg-placeholder">
...
?><table border="1" class=" table table-bordered mg-b-0 bg-placeholder" >
    <tr>
        <th>Full Name</th>
...
<?php if($row['remark']==""){ ?>
    ...
    <th>Outing Remark :</th>
    <td>
    <textarea name="remark" placeholder="" rows="12" cols="14" class="form-control wd-450 bg-placeholder" required="true"></textarea></td>
  </tr>                               
 <tr align="center">
