...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT-->
            <div class="main-content bg-placeholder">
...
?>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9"> 
                                                    <input type="password" id="currentpassword" name="currentpassword" value=""  placeholder=" Current Passward"class="form-control bg-placeholder" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="password" id="newpassword" name="newpassword" value="" placeholder=" new Passward" class="form-control bg-placeholder" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="password" id="confirmpassword" name="confirmpassword" placeholder=" Confirm Passward" class="form-control bg-placeholder" maxlength="10" value="" required="">
