...
<body class="animsition">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12" Style="background-color: #161D29; text-color:#fff;>
                                <div class= "card" >
                                    <div class="card-header" Style=" color:#fff;  >
                                        <strong ">Add</strong> New Visitors
                                    </div>
                                    <div class="card-body card-block" Style="background-color: #161D29; color:#fff;">
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label bg-placeholder">Address</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="whomtomeet" name="whomtomeet" placeholder="Whom to Meet" class="form-control bg-placeholder" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="department" name="department" placeholder="Department" class="form-control bg-placeholder" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="reasontomeet" name="reasontomeet" placeholder="Reason To Meet" class="form-control bg-placeholder" required="">
                                                    
                                                </div>
                                            </div>
                                            
                                          <div class="card-footer">
                                        <p style="text-align: center"><button type="submit" name="submit" id="submit" class="btn ">Submit
                                        </button></p>
